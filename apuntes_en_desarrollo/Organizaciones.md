...
Las organizaciones son formaciones sociales, grupos de personas que se dividen el trabajo para lograr un objetivo en comun, una necesidad social justifica las acciones de una organizacion y asegura su existencia.

Existen varias formas de clasificar a una organizacion: Segun su naturaleza (si es lucrativa o sin fines de lucro), segun su forma juridica o propiedad (si es publica, si es privada, una S.A, una S.R.L, una cooperativa o una org mixta) o segun su rubro de actividad (si es industrial, provedora de servicios, comercial, etc), ademas las organizaciones pueden tener varios fines como es el caso de las universidades que funcionan como organizaciones de educacion y de investigacion.

Toda organizacion tiene un fin, una razon de ser, una mision que responde a las siguientes preguntas ¿Quienes somos? ¿Que hacemos? ¿Cual es nuestra rama de actividad? y ¿Quienes son nuestros beneficiarios o clientes? Esta mision es complementada por la vision (una imagen a futuro), entre ambas crean un marco de acciones al igual que reprecentan sus valores y principios.
...
El desplazamiento de fines sucede cuando las prioridades de una organizacion se dividen entre los medios y su finalidad. Esto puede suceder, por ejemplo debido a la dinamica organizacional pueden existir necesidades que la organizacion debe satizfacer para poder realizar sus objetivos, estas necesidades llevan a invertir recursos en actividades que no estan directamente relacionadas con los objetivos de la empresa, pero pueden retribuir economicamente. Ademas tambien pueden existir diferentes grupos internos con intereses diferentes o buracracia que frene el accionar.
...
Dentro de la teoria general de sistemas (TGS) todo sistema forma parte de uno mayor que lo incluye y el todo es mucho más que la suma de sus partes. Los sistemas sociales que llamamos organizaciones son grupos y sub grupos de personas con tareas y responsabilidas diferentes en pos de un objetivo comun, dicho esto podemos afirmar que una organizacion es un sistema social vivo y dinamico, nunca esta inerte o acabado, sino en constantemente cambio y reinvencion.
